...
[![Build & Release APK](https://github.com/Jeeva-zone/scanner-fav/actions/workflows/build-apk.yml/badge.svg)](https://github.com/Jeeva-zone/scanner-fav/actions/workflows/build-apk.yml)
[![Release](https://img.shields.io/github/v/release/Jeeva-zone/scanner-fav?label=release&color=2ea043)](https://github.com/Jeeva-zone/scanner-fav/releases/latest)
[![Downloads](https://img.shields.io/github/downloads/Jeeva-zone/scanner-fav/latest/total?label=downloads&color=0969da)](https://github.com/Jeeva-zone/scanner-fav/releases/latest)
...
publishes both APKs to the [`latest`](https://github.com/Jeeva-zone/scanner-fav/releases/latest) release.

| APK | Build type | Download |
| --- | ---------- | -------- |
| `StatusPing-v1.0.apk` | release | [Download](https://github.com/Jeeva-zone/scanner-fav/releases/download/latest/StatusPing-v1.0.apk) |
| `StatusPing-debug.apk` | debug | [Download](https://github.com/Jeeva-zone/scanner-fav/releases/download/latest/StatusPing-debug.apk) |

### Install from a phone

1. Open the download link above, or go to the [Releases](https://github.com/Jeeva-zone/scanner-fav/releases) tab.
...
1. Open the [Actions](https://github.com/Jeeva-zone/scanner-fav/actions) tab.
...
git clone https://github.com/Jeeva-zone/scanner-fav.git
cd scanner-fav
